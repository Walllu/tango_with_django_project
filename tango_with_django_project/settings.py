...
SECRET_KEY = 'fm6d44$b7g2qs9*5ga^8gv%t6m$(+hyj)$()8&0jnjoa_u!11s'
...
LOGIN_URL = '/accounts/login/' # This points to the registration_redux login template -- ch.11 -- I'm a little confused though, because this was what it was before?
